...
tbl_data <- bccc |>
  ...
  mutate(
    ...
    value = case_when(
      ...
      value == 'UNDER36' ~ '<36 months',
      value == 'LICPRE' ~ 'Licensed Pre-schoold',
...
function filter_default() {
  document.getElementById("CITY").getElementsByClassName("selectized")[0].selectize.setValue("Richmond", false);
}
...
Last date that dataset has been checked: `{r} .today`
